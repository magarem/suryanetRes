<template>
  <header
    class="flex items-center justify-between h-16 bg-gray-800/50 backdrop-blur-sm border-b border-gray-700 px-6 sticky top-0 z-20"
  >
    <!-- Sidebar Toggle Button & Domain Name -->
    <div class="flex items-center">
      <button
        @click="$emit('toggleSidebar')"
        class="p-2 rounded-md hover:bg-gray-700 focus:outline-none focus:ring-2 focus:ring-inset focus:ring-indigo-500"
      >
        <Menu class="h-6 w-6" />
      </button>
      <h1 class="text-xl font-bold text-white ml-4 hidden sm:block">
        Novagokula
      </h1>
    </div>
    ...
    <div class="flex items-center space-x-4">
      ...
      <div class="relative" ref="notificationMenu">
        ...
        >
          <div
            ...
            class="absolute right-0 mt-2 w-80 bg-gray-800 border border-gray-700 rounded-lg shadow-xl overflow-hidden z-10"
          >
            ...
            <div class="divide-y divide-gray-700">
              <a
                ...
                href="#"
                class="flex items-start px-4 py-3 hover:bg-gray-700"
              >
                <component
              ...
              <a
                href="#"
                class="flex items-center justify-center px-4 py-2 text-sm font-medium text-indigo-400 hover:bg-gray-700"
              >
      ...
      <div class="relative" ref="userMenu">
        ...
        >
          ...
          /> -->
          <img
            :src="`/api/uploads/${user.username}/avatar.png?${Date.now()}`"
            alt="Foto de Perfil"
            class="h-9 w-9 rounded-full object-cover ring-2 ring-offset-2 ring-offset-gray-800 ring-transparent"
          />
          <span class="sm:inline">{{ user.username }}</span>
        </button>
        ...
        >
          <div
            ...
            class="absolute right-0 mt-2 w-48 bg-gray-800 border border-gray-700 rounded-lg shadow-xl py-1 z-10"
          >
            <template v-for="item in userMenuItems" :key="item.name">
              ...
              <button
                ...
                @click="item.action"
                class="w-full text-left flex items-center px-4 py-2 text-sm hover:bg-gray-700"
                :class="item.class || 'text-gray-300'"
              >
